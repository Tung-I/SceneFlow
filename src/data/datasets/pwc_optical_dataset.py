...
class PWCOpticalDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.type == 'train':
            rgb_l, rgb_next_l, flow = self.train_preprocessings(rgb_l, rgb_next_l, flow)
        ...
        return {"rgb_l": rgb_l, "rgb_next_l": rgb_next_l, "flow": flow}
