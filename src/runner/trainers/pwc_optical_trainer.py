...
class PWCOpticalTrainer(BaseTrainer):
    ...
    def _run_epoch(self, mode):
        ...
        for batch in trange:
            ...
            rgb_l, rgb_next_l, target = self._get_inputs_targets(batch)
            ...
            if mode == 'training':
                outputs = self.net(rgb_l, rgb_next_l)
    ...
    def _get_inputs_targets(self, batch):
        ...
        """
        return batch['rgb_l'], batch['rgb_next_l'], batch['flow']
